    ...
    public partial class SeedDepartments : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 12, null, "Information Technology (IT) Department", "Responsible for maintaining and securing the organization's IT infrastructure, ensuring smooth operation of systems, networks, and software.", "EYcLYD+5MDZefgLOMIoszTVmLL6YuHDc/r7gSnhjOMI=" },
                    { 13, null, "Human Resources (HR) Department", "Handles employee-related issues, including recruitment, workplace policies, and conflict resolution.", "1L9JFDAOhdRAfr8WTE2TFseSIbmFznhF8G+YQYeQztU=" },
                    { 14, null, "Facilities Management Department", "Ensures the maintenance and safety of physical office spaces, including repairs and environmental concerns.", "6G7QdUkik1mqrvrGW7onUkJgMDX0uWCx8eO5CGPAafI=" },
                    { 15, null, "Customer Support Department", "Addresses customer complaints, inquiries, and service-related issues to maintain customer satisfaction.", "WKGIl7ur+NipjdwcCelAQMAWgwI4+yUKRAUJ+rwnUrI=" },
                    { 16, null, "Health and Safety Department", "Ensures workplace safety, compliance with health regulations, and handles medical emergencies.", "CfNwST/Pp0U9H/1bbkTQOQ308K05oiLvpcTGdLosZNA=" }
                });
